...
public struct HotmartDarkGreenColor: ProductColor, SparkleColors {
    /// green_darker
    ...
    struct Darker: SystemColor {
        ...
        /// `green_darker` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.success600
    ...
    struct Dark: SystemColor {
        ...
        /// `green_darker` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.success500
    ...
    struct Green: SystemColor {
        ...
        /// `green` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.success400
    ...
    struct Light: SystemColor {
        ...
        /// `green_light` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.success300
    ...
    struct Lighter: SystemColor {
        ...
        /// `green_lighter` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.success200
    ...
    struct Lightest: SystemColor {
        ...
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.success100
