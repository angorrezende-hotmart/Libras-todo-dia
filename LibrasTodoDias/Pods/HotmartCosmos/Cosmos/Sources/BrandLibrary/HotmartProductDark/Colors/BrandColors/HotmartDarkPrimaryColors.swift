//
//  HotmartDarkPrimaryColors.swift
//  HotmartCosmos
//
...
public struct HotmartDarkPrimaryColor: BrandColor, SparkleColors {
    /// DARKER
    ...
    struct Darker: SystemColor {
        ...
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.primary600
    ...
    struct Dark: SystemColor {
        ...
        /// `primary_dark` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.primary500
    ...
    struct Primary: SystemColor {
        ...
        /// `"primary"` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.primary400
    ...
    struct Light: SystemColor {
        ...
        /// `"primary_light"` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.primary300
    ...
    struct Lighter: SystemColor {
        ...
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.primary200
    ...
    struct Lightest: SystemColor {
        ...
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.primary100
