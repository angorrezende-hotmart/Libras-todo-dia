...
public struct HotmartDarkBlueColor: ProductColor, SparkleColors {
    /// blue_darker
    ...
    struct Darker: SystemColor {
        ...
        /// `blue_darker` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.info600
    ...
    struct Dark: SystemColor {
        ...
        /// `blue_darker` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.info500
    ...
    struct Blue: SystemColor {
        ...
        /// `blue` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.info400
    ...
    struct Light: SystemColor {
        ...
        /// `blue_light` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.info300
    ...
    struct Lighter: SystemColor {
        ...
        /// `blue_lighter` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.info200
    ...
    struct Lightest: SystemColor {
        ...
        /// `blue_lightest` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.info100
