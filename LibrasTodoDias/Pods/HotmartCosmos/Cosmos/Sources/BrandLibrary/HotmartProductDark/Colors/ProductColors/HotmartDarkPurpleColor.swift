...
public struct HotmartDarkPurpleColor: ProductColor, SparkleColors {
    /// purple_darker
    ...
    struct Darker: SystemColor {
        ...
        /// `purple_darker` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.andromeda600
    ...
    struct Dark: SystemColor {
        ...
        /// `purple_darker` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.andromeda500
    ...
    struct Purple: SystemColor {
        ...
        /// `purple` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.andromeda400
    ...
    struct Light: SystemColor {
        ...
        /// `purple_light` color
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.andromeda300
    ...
    struct Lighter: SystemColor {
        ...
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.andromeda200
    ...
    struct Lightest: SystemColor {
        ...
        let color: UIColor = HotmartProductDarkStyleDictionaryColor.andromeda100
