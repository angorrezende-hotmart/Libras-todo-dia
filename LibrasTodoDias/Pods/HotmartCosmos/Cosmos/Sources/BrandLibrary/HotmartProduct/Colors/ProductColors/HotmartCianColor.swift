...
public struct HotmartCianColor: ProductColor, SparkleColors {
    /// cian_darker
    ...
    struct Darker: SystemColor {
        ...
        /// `cian_darker` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.sirius600
    ...
    struct Dark: SystemColor {
        ...
        /// `cian_darker` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.sirius500
    ...
    struct Cian: SystemColor {
        ...
        /// `cian` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.sirius400
    ...
    struct Light: SystemColor {
        ...
        /// `cian_light` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.sirius300
    ...
    struct Lighter: SystemColor {
        ...
        /// `cian_lighter` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.sirius200
    ...
    struct Lightest: SystemColor {
        ...
        /// `cian_lightest` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.sirius100
