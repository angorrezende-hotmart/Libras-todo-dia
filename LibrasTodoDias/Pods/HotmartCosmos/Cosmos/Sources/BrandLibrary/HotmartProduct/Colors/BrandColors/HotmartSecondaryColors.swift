...
public struct HotmartSecondaryColor: BrandColor, SparkleColors {
    /// DARKER
    ...
    struct Darker: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.secondary600
    ...
    struct Dark: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.secondary500
    ...
    struct Secondary: SystemColor {
        ...
        /// `"secondary"` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.secondary400
    ...
    struct Light: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.secondary300
    ...
    struct Lighter: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.secondary200
    ...
    struct Lightest: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.secondary100
