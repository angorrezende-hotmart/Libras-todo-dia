...
public struct HotmartYellowColor: ProductColor, SparkleColors {
    /// yellow_darker
    ...
    struct Darker: SystemColor {
        ...
        /// `yellow_darker` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.warning600
    ...
    struct Dark: SystemColor {
        ...
        /// `yellow_darker` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.warning500
    ...
    struct Yellow: SystemColor {
        ...
        /// `yellow` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.warning400
    ...
    struct Light: SystemColor {
        ...
        /// `yellow_light` color
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.warning300
    ...
    struct Lighter: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.warning200
    ...
    struct Lightest: SystemColor {
        ...
        let color: UIColor = HotmartProductBaseStyleDictionaryColor.warning100
