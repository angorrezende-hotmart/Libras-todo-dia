...
public struct SparkleDarkBlueColor: ProductColor, SparkleDarkColors {
    /// blue_darker
    ...
    struct Darker: SystemColor {
        ...
        let onColor: UIColor = blueLighter
    }
    ...
    struct Light: SystemColor {
        ...
        /// `on_blue_light` color
        let onColor: UIColor = blueDarker
    }
