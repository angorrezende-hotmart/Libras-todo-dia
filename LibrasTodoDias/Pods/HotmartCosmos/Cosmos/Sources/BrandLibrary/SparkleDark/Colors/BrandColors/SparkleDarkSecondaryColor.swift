//
//  SparkleDarkSecondaryColor.swift
//  HotmartCosmos
//
...
public struct SparkleDarkSecondaryColor: BrandColor, SparkleDarkColors {
    /// DARKER
    ...
    struct Darker: SystemColor {
        ...
        let onColor: UIColor = secondaryLightest
    }
    ...
    struct Light: SystemColor {
        ...
        let onColor: UIColor = neutral200
    }
    ...
    struct Lighter: SystemColor {
        ...
        let onColor: UIColor = secondaryDarker
    }
