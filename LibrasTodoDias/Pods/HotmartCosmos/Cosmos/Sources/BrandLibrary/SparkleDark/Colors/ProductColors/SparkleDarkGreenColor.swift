...
public struct SparkleDarkGreenColor: ProductColor, SparkleDarkColors {
    /// green_darker
    ...
    struct Darker: SystemColor {
        ...
        let onColor: UIColor = greenLighter
    }
    ...
    struct Light: SystemColor {
        ...
        let onColor: UIColor = greenDarker
    }
